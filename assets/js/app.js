...
/***/ "./src/assets/js/lib/countdown.js":
/*!****************************************!*\
  !*** ./src/assets/js/lib/countdown.js ***!
  \****************************************/
/***/ ((module) => {
...
/* harmony import */ var _lib_countdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/countdown */ "./src/assets/js/lib/countdown.js");
/* harmony import */ var _lib_countdown__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_lib_countdown__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _lib_foundation_explicit_pieces__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/foundation-explicit-pieces */ "./src/assets/js/lib/foundation-explicit-pieces.js");
...
function initEasterEgg() {
  ...
  new konami__WEBPACK_IMPORTED_MODULE_4__(function () {
    isEggEnabled = !isEggEnabled;
    document.cookie = "npcEgg=".concat(isEggEnabled ? 'true' : 'false');
    var status = isEggEnabled ? 'e]\[@bl3D' : 'diZ481Ed';
    console.log("H4x0r l337 ]/[0D3 ".concat(status, "..."));
    updateEggMode(isEggEnabled);
  });
}
...
function enableEggMode() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass("".concat(CSS_PREFIX, "--l33tMode"));
}

function disableEggMode() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass("".concat(CSS_PREFIX, "--l33tMode"));
}

function initFlickity() {
  var elem = document.querySelector(".".concat(CSS_PREFIX, "__flickity-gallery"));

  if (!elem) {
    return;
  }

  var gallery = new flickity__WEBPACK_IMPORTED_MODULE_3__(elem, {
    autoPlay: false,
    cellAlign: "left",
    freeScroll: true,
    imagesLoaded: true,
...
function initCountdown() {
  ...
  var timerId = _lib_countdown__WEBPACK_IMPORTED_MODULE_2__(new Date(window.schrags.global.eventDate), function (ts) {
    elem.innerHTML = ts.toHTML();
  }, _lib_countdown__WEBPACK_IMPORTED_MODULE_2__.DAYS | _lib_countdown__WEBPACK_IMPORTED_MODULE_2__.HOURS | _lib_countdown__WEBPACK_IMPORTED_MODULE_2__.MINUTES | _lib_countdown__WEBPACK_IMPORTED_MODULE_2__.SECONDS);
}
...
function initSignUp() {
  ...
  if (button) {
    button.addEventListener('click', function (e) {
      ...
      var updatesForm = document.querySelector(".".concat(CSS_PREFIX, "__updates-form"));
      var updatesMessage = document.querySelector(".".concat(CSS_PREFIX, "__updates-message"));
      var payload = {
        name: name,
        email: email
      };
...
function initRegistration() {
  ...
  function paymentChange() {
    var index = payment.selectedIndex;
    reset();
  ...
  function sizeChange() {
    ...
    var url = "https://venmo.com/?txn=pay&audience=private&recipients=schrags08&amount=35&note=NPC2023-".concat(sizeOption);

    if (sizeIndex > 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.checkout--venmo').show();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.checkout--venmo').find('a').attr('href', url);
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.checkout--venmo').hide();
    }
  }

  function reset() {
    size.selectedIndex = 0;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modifier').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.checkout').hide();
  }

  function showVenmo() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modifier').show();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.checkout').hide();
  }
  ...
  function showPayPal() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modifier').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.checkout').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.checkout--paypal').show();
  }
}
})();
